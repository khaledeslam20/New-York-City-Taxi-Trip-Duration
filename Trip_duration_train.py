...
def main() :
    ...
    x_train, y_train, x_val, y_val = load_data(
        args.train_path, args.val_path, args.val_size, args.target_col
    )
    ...
    save_model_with_columns(ridge, scaler, x_train.columns, model_path, scaler_path,column_path)
